...
class Dienorastis:
    ...
    def statistika(self) -> dict:
        ...
        return {
            ...
            "vid_svoris": round(sum(svoriai) / len(svoriai), 2) if svoriai else 0,
...
class ZvejoDienorastisApp(tk.Tk):
    ...
    def _sukurti_sarasa_panel(self, parent):
        ...
        ttk.Button(toolbar, text="✏ Kopijuoti",
                   ...
                   command=self._kopijuoti_irasa).pack(side="right", padx=(0, 5))
    ...
    def _sukurti_formos_laukus(self, parent):
        ...
        self.nuotr_label = tk.Label(nuotr_frame,
    ...
    def _issaugoti(self):
        try:
            ...
            messagebox.showerror("Klaida",
                f"Patikrinkite skaičių laukus (svoris, ilgis, temperatūra)")
